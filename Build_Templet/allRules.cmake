...
elseif(CROSS_PLATFORM STREQUAL HI3516CV500)
	...
	message(STATUS "===> Cross Platform : HI3516CV500")	
elseif(CROSS_PLATFORM STREQUAL HI3519AV100)
	set(CMAKE_FIND_ROOT_PATH "/opt/hisi-linux/x86-arm/arm-himix200-linux")
	set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM ONLY)
	set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
	set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
	...
	set(CMAKE_C_FLAGS "-Wall -O2 -Os -D_REENTRANT -mcpu=cortex-a53 -mfloat-abi=softfp -mfpu=neon-vfpv4 -mno-unaligned-access -fno-aggressive-loop-optimizations -ffunction-sections -fdata-sections")
	set(CMAKE_CXX_FLAGS "-Wall -O2 -Os -D_REENTRANT -mcpu=cortex-a53 -mfloat-abi=softfp -mfpu=neon-vfpv4 -mno-unaligned-access -fno-aggressive-loop-optimizations  -ffunction-sections -fdata-sections")
	set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,-gc-sections")
	...
	message(STATUS "===> Cross Platform : HI3519AV100")	
